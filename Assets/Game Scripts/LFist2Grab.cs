...
public class LFist2Grab : Photon.MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetButton("Fire1")){
			...
			if (grabAndLaunch.holding == false && gameObject.name != "launching" && Rfist1.name != "launching" && Rfist2.name != "launching" && Lfist1.name != "launching")		
			{
