...
public class RFist2Grab : Photon.MonoBehaviour {
	...
	void Update () {
		...
		if(Input.GetButton("Fire1")){
			...
			if (grabAndLaunch.holding == false && gameObject.name != "launching" && Rfist1.name != "launching" && Lfist1.name != "launching" && Lfist2.name != "launching")		
			{
